            ...
            <div class="grid-cell grid-cell--col12 mt-2">
              <nav class="sessions__navbar grid">
                <div class="grid u-justify-space u-align-center">
                  ...
                  <p class="f12">
                    Đã có tài khoản?
                    <a id="_login" @click="backwardPage">Đăng nhập</a>
                  </p>
                </div>
              </nav>
            </div>
            <div
              class="grid-cell grid-cell--col5--desktop-s desktop-s grid-cell--col5--desktop grid-cell--col4--desktop-l"
            >
              <section class="signup__info"></section>
            </div>
            <div
              class="grid-cell grid-cell--col2--desktop-s desktop-s grid-cell--col2--desktop grid-cell--col3--desktop-l"
            ></div>
            <div
              class="grid-cell grid-cell--col12--tablet grid-cell--col5--desktop-s grid-cell--col5--desktop grid-cell--col4--desktop-l"
            >
              <section class="signup__form">
                ...
                <div class="form">
                  <div :class="{hidden: is_setup}" class="form__field">
                    ...
                    <p
                      :class="{hidden: error_email_format}"
                  ...
                  <div :class="{hidden: is_setup}" class="form__field">
                    ...
                    <div class="form__input-icon">
                      <input
                        id="password"
                        v-model="password"
                        @keyup.enter="nextPasswordRetype"
                        class="form__input"
                        type="password"
                      />
                      <p
                        :class="{hidden: error_pass}"
                        id="form__input-error"
                      >Bạn cần phải nhập password</p>
                      <p
                        :class="{hidden: error_pass_format}"
                        id="form__input-error"
                      >Mật khẩu của bạn phải chứa tối thiểu 8 ký tự</p>
                      <p
                        :class="{hidden: pass_format}"
                  ...
                  <div :class="{hidden: is_setup}" class="form__field">
                    ...
                    <div class="form__input-icon">
                      ...
                      />
                      <p
                        :class="{hidden: error_repass}"
                        id="form__input-error"
                      >Bạn cần phải nhập lại mật khẩu</p>
                    </div>
                  </div>
                  <div :class="{hidden: setup_success}" class="form__field">
                    ...
                    <input
                      id="full-name"
                      v-model="fullName"
                      @keyup.enter="nextPhoneNumber"
                      class="form__input"
                    />
                    <p
                      :class="{hidden: error_fullname}"
                      id="form__input-error"
                    >Bạn cần phải nhập họ và tên</p>
                  </div>
                  <div :class="{hidden: setup_success}" class="form__field">
                    ...
                    />
                    <p
                      :class="{hidden: error_phone}"
                      id="form__input-error"
                    >Bạn cần phải nhập số điện thoại</p>
                  </div>
    ...
    async next() {
      if (
        ...
        if (this.passwordRetype == "") {
          document.getElementById("passwordRetype").style.border =
            "2px solid red";
...
@media (max-width: 425px), (min-width: 801px) and (max-width: 1223px) {
  .form__label {
...
.signup__circleMap {
  ...
  border-radius: 50%;
  background-color: #162945;
  background-image: linear-gradient(160deg, rgba(22, 41, 69, 0) 0%, #162945 85%),
    url(/assets/backgrounds/signup-a24f239290c3a2fff00736fb0f86a9584f38fcf7c1175a2c23c76f48f79c27a3.svg);
...
@font-face {
  ...
  src: url(/assets/OpenSans-Regular-31b6b855254621325884ebeee8f42134e48c68bde9c41552e8f701d483d47cba.eot?#iefix)
      format("embedded-opentype"),
    url(/assets/OpenSans-Regular-e64e508b2aa2880f907e470c4550980ec4c0694d103a43f36150ac3f93189bee.ttf)
      format("truetype");
  font-weight: 400;
  font-style: normal;
}
...
@font-face {
  ...
  src: url(/assets/OpenSans-Light-b448a4cfed238e77ca88a2ff4ee399065e6b0ccc1a8fbf846620249f6c79e145.eot?#iefix)
      format("embedded-opentype"),
    url(/assets/OpenSans-Light-cf5f5184c1441a1660aa52526328e9d5c2793e77b6d8d3a3ad654bdb07ab8424.ttf)
      format("truetype");
  font-weight: 300;
  font-style: normal;
}
...
@font-face {
  ...
  src: url(/assets/OpenSans-Semibold-b132fd47c96da989d9a505f882ab62fde74e7c0863192adb4f0d4c4b749b9a9e.eot?#iefix)
      format("embedded-opentype"),
    url(/assets/OpenSans-Semibold-aa3b0ef53db12e3d45094030cac0e69d384e44cc5978643dd4390041cad546e2.ttf)
      format("truetype");
  font-weight: 600;
  font-style: normal;
}
...
@font-face {
  ...
  src: url(/assets/montserrat-regular-webfont-cc730bc36272778104deb3754725004417689f984ca24f0a85ceacb9d2c102b1.eot?#iefix)
      format("embedded-opentype"),
    url(/assets/montserrat-regular-webfont-2689fd5fa69e3427496f977d75de982466aebdef78ab9b97a510f1e7fe75feec.ttf)
      format("truetype");
  font-weight: 400;
  font-style: normal;
}
...
@font-face {
  ...
  src: url(/assets/montserrat-semibold-webfont-664d7873aa23a7dee18fb9563f80a70f21b2144e60f9275558dce19a2990dd9f.eot?#iefix)
      format("embedded-opentype"),
    url(/assets/montserrat-semibold-webfont-0563c10d1602f0e8bb1813e2473232f418952c5545a4d6d812e1964984fc29f0.ttf)
      format("truetype");
  font-weight: 600;
  font-style: normal;
}
...
@font-face {
  ...
  src: url(/assets/montserrat-bold-webfont-dd5428974e2cd8cbcf9e5ab65d7340997047a04e70a9d9619ceff74e158f3f6b.eot?#iefix)
      format("embedded-opentype"),
    url(/assets/montserrat-bold-webfont-e0a627c9b8df39918fbd511d05bd460fab87e1c133daa03ac8a912d3433fbcb8.ttf)
      format("truetype");
  font-weight: bold;
  font-style: normal;
}
...
@font-face {
  ...
  src: url(/assets/Roboto-Medium-0c743a880dc0cfd9028f74d7b23db7131ff230f0927129418de147be4f556031.woff)
    format("woff");
  font-weight: 500;
  font-style: normal;
}
