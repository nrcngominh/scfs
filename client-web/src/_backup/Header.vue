        ...
        <nav class="Navbar">
          <div id="navbar" class="container grid u-justify-center">
              ...
              <div class="Navbar-collapse">
                <ul class="Navbar-list">
                  <li class="Navbar-item Dropdown">
                    <a @click="home" :class="{active: home_active}" class="Navbar-link title f12">
                      <span>Home</span>
                    </a>
                  </li>
                  ...
                  <li class="Navbar-item">
                    <a
                      @click="gotrans"
                      :class="{active: trans_active}"
                      class="Navbar-link title f12"
                    >
                      <span id="platform">Transaction</span>
                    </a>
                  </li>
                  <li class="Navbar-item">
                    <a :class="{active: about_active}" class="Navbar-link title f12">
                      <span>About Us</span>
                    </a>
                  </li>
                </ul>
            ...
            <div class="Navbar-element">
              <ul>
                <li :class="{hidden: isActive}">
                  <a @click="forwardLogin" class="button-small is-blue">
                    <span>Đăng nhập</span>
                  </a>
                </li>
                <li :class="{hidden: isActive}">
                  <a @click="forwardRegister" class="button-small is-blued">
                    <span>Đăng ký</span>
                  </a>
                </li>
                <li :class="{hidden: isLogined}">
                  <div class="dropdown" id="avatar">
                    ...
                    <div class="dropdown-content">
                      <a v-for="noti in $store.state.notifications" :key="noti.id">
